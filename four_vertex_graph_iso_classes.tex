...
\newcommand{\orbitSix}{\begin{tikzpicture}[scale=0.25, line cap=round, line width=1pt]
		% adjacent edges
		\begin{scope}[shift={(0,0)}]
			\orbitGraphCoords
			\draw (A)--(D)--(B)--(A);
...
\newcommand{\orbitSeven}{\begin{tikzpicture}[scale=0.25, line cap=round, line width=1pt]
		% adjacent edges
		\begin{scope}[shift={(0,0)}]
			\orbitGraphCoords
			\draw (A)--(B)--(C)--(D)--(A);
...
\newcommand{\orbitEight}{\begin{tikzpicture}[scale=0.25, line cap=round, line width=1pt]
		% row 1
		\begin{scope}[shift={(0,0)}]
			\orbitGraphCoords
			\draw (A)--(B)--(C)--(A);
...
\newcommand{\orbitNine}{\begin{tikzpicture}[scale=0.25, line cap=round, line width=1pt]
		% row 1
		\begin{scope}[shift={(0,0)}]
			\orbitGraphCoords
			\draw (B)--(A)--(D)--(C)--(A);
...
\newcommand{\orbitTen}{\begin{tikzpicture}[scale=0.25, line cap=round, line width=1pt]
		% adjacent edges
		\begin{scope}[shift={(0,0)}]
			\orbitGraphCoords
			\draw (A)--(D) (B)--(C);
...
\newcommand{\orbitEleven}{\begin{tikzpicture}[scale=0.25, line cap=round, line width=1pt]
		% adjacent edges
		\begin{scope}[shift={(0,0)}]
			\orbitGraphCoords
			\draw (A)--(B) (A)--(D) (A)--(C);
