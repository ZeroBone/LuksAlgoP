...
\begin{frame}{Sketch of proof of Babai-Luks theorem}
	\begin{itemize}
		...
		\item For every $ (e_0, e_1) \in E(G_0) \times E(G_1) $, compute the following gadget
	\end{itemize}
	\begin{center}
		\begin{tikzpicture}[scale=0.8, thick]
			...
			\begin{scope}[shift={(-3.5,0)}]
				...
				\node[grnode, right=.5 of v05] (v06) {6};
				\node[grnode, right=.5 of v06] (v07) {7};
			...
			\begin{scope}[shift={(3.5,0)}]
				...
				\node[grnode, right=.5 of v15] (v16) {f};
				\node[grnode, right=.5 of v16] (v17) {g};
