...
% TODO: state lemma in terms of ker and im
...
\begin{frame}{Proof of Luks's theorem}
	\begin{columns}
		...
		\begin{column}{0.35\textwidth}  %%<--- here
			Let $ R_i $ be a subgraph of $ G $ induced by nodes reachable in $ \le i $ steps from $ v $
...
\begin{frame}{Proof of Luks's theorem (continued)}
	...
	\textbf{Inductive step}:\begin{itemize}
		\item By IH, $ \Aut(R_{i-1}, v) \in \GammaD $
		...
		\item By FHT, \[
		\Aut(R_i, v)/\KernelOf(\varphi_i) \cong \ImageOf(\varphi_i) = \Aut(R_{i-1}, v) \in \GammaD
		\]
	...
	\begin{columns}
		...
		\begin{column}{0.65\textwidth}
			...
			\begin{itemize}
				...
				\item $ \rightsquigarrow \KernelOf(\varphi_i) \le S_d^m $
...
% TODO: put BCP here in compressed version and reformulate it in terms of ker and im

% TODO: remove in compressed version
...
% TODO: compress into one slide in compressed version
