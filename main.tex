...
\begin{frame}{Sketch of proof of Babai-Luks theorem}
	\begin{itemize}
		...
		\item For every $ (e_0, e_1) \in G_0 \times G_1 $, compute the following gadget
	\end{itemize}
	\textbf{Example}:
	\begin{center}
		\begin{tikzpicture}[every node/.style={circle, draw, fill=gray!10, inner sep=1pt, minimum size=18pt}, scale=0.8]
			
			\def\r{3.25}                % inner frontier base radius (around v)
			\def\A{0.1}                 % inner wave amplitude (radial)
			\def\n{32}                  % number of waves (integer) for inner frontier
			
			\begin{scope}[shift={(-3.3,0)}]
				% nodes
				\node (v01) at (0,0) {1};
				\node[above=1 of v01] (v03) {3};
				\node[left=.5 of v03] (v02) {2};
				\node[right=.5 of v03] (v04) {4};
				\node[above=1 of v03] (v05) {5};
				\node[right=.5 of v05] (v06) {6};
				\node[right=.5 of v06] (v07) {7};
	
				% edges
				\draw (v01)--(v02) (v01)--(v03) (v01)--(v04);
			...
			\begin{scope}[shift={(3.3,0)}]
				% nodes
				\node (v11) at (0,0) {a};
				\node[above=1 of v11] (v13) {c};
				\node[left=.5 of v13] (v12) {b};
				\node[right=.5 of v13] (v14) {d};
				\node[above=1 of v13] (v15) {e};
				\node[right=.5 of v15] (v16) {f};
				\node[right=.5 of v16] (v17) {g};
				
				% edges
				\draw (v11)--(v12) (v11)--(v13) (v11)--(v14);
