		...
		\begin{columns}
			\begin{column}{0.4\textwidth}
				\begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2.5cm}}
					...
					\hline\orbitOne&$ S_4 $\\
					\hline\orbitTwo&$ S_4 $\\
					\hline\vspace{5pt}\orbitThree&$ \gen{(1\,3)} $\\
					\hline\vspace{5pt}\orbitFour&$ \gen{(1\,3)} $\\
			...
			\begin{column}{0.4\textwidth}
				\begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2.5cm}}
					Orbit&Stabilizer\\
					\hline\vspace{5pt}\orbitSeven&$ \gen{(1\,4)(2\,3)} $\\
					\hline\orbitEight&$ S_3 $\\
					\hline\orbitNine&$ S_3 $\\
					\hline\vspace{5pt}\orbitTen&$ \gen{(1\,2),(3\,4)} $\\
					\hline\vspace{5pt}\orbitEleven&$ \gen{(1\,2),(3\,4)} $
				\end{tabular}
			\end{column}
		\end{columns}
	\end{center}
