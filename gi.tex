	...
	\begin{center}
		\begin{tikzpicture}[scale=.8, thick]
			...
			\begin{scope}[shift={(4,0)}]
				...
				\node[below=0 of l5] (blocksystemofdot2) {$ \underbrace{\{\textcolor{TurquoiseZB}{\underbrace{\{1,3,5,7\}}_{\Delta'}},\textcolor{MagentaZB}{\underbrace{\{2,4,6,8\}}_{r\cdot\Delta'}}\}}_{\text{Block system of}\ \cdot} $};
			\end{scope}
