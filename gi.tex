		...
		\begin{columns}
			\begin{column}{0.4\textwidth}
				\begin{tabular}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2.5cm}}
					Orbit&Stabilizer of \textcolor{yellow!90!black}{$ G $}\\
...
\begin{frame}{Primitive actions and groups}
	\begin{itemize}
		...
		\item Running example: $ \{\textcolor{red!80}{\{1,4\}},\textcolor{OliveGreenZB!80}{\{2,5\}},\textcolor{blue!80}{\{3,6\}}\} $ and $ \{\textcolor{red!80}{\{2,4,6\}},\textcolor{blue!80}{\{1,3,5\}}\} $ are minimal but $ \{\{1\}, \{2\}, \{3\}, \{4\}, \{5\}, \{6\}\} $ is not
