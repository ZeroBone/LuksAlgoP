		...
		\begin{columns}
			\begin{column}{0.6\textwidth}
				\begin{itemize}
					...
					\item $ \diamond $ can also be seen as the \begin{align*}
...
\begin{frame}{Kernels of block-induced homomorphisms}
	\begin{itemize}
		...
		\item Clearly, \[
			\KernelOf(\psi_\Delta) = \bigcap_{\gamma \in \Gamma} \Stab_\diamond(\gamma \cdot \Delta)
		\]
	\end{itemize}
	\begin{center}
		\begin{tikzpicture}[scale=1, thick]
				...
				% stabilizers
				\node[below=0 of blocksystem] (ex1) {$ \Stab_\diamond(\textcolor{red!80}{\{1,4\}}) = \gen{\textcolor{red!80}{f}, \textcolor{DarkOrangeZB}{fr^3}} $};
				\node[below=0 of ex1] (ex2) {$ \Stab_\diamond(\textcolor{OliveGreenZB!80}{\{2,5\}}) = \gen{\textcolor{OliveGreenZB!80}{fr^4}, \textcolor{MagentaZB}{fr}} $};
				\node[below=0 of ex2] (ex3) {$ \Stab_\diamond(\textcolor{blue!80}{\{3,6\}}) = \gen{\textcolor{blue!80}{fr^2}, \textcolor{TurquoiseZB}{fr^5}} $};
...
\begin{frame}{Decomposing groups using block-induced homomorphisms}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1, thick]
			...
			% stabilizers
			\node[below=0 of blocksystem] (ex1) {$ \Stab_\diamond(\textcolor{red!80}{\{2,4,6\}}) = \gen{\textcolor{gray}{r^2}, \textcolor{MagentaZB}{f}} $};
			\node[below=0 of ex1] (ex2) {$ \Stab_\diamond(\textcolor{blue!80}{\{1,3,5\}}) = \gen{\textcolor{gray}{r^2}, \textcolor{MagentaZB}{f}} $};
	...
	\begin{itemize}
		...
		\item $ \rightsquigarrow $ If $ T $ is a transversal of $ \Gamma/\KernelOf(\psi_\Delta) $, then every $ \gamma \in \Gamma $ can be written as $ t\sigma $ for some (unique) $ t \in T $ and $ \sigma \in \KernelOf(\psi_\Delta) $
	\end{itemize}
\end{frame}
